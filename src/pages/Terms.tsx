  ...
  return (
    <>
      <SEO 
        ...
        description="Read the terms of service for VoiceMate voice identification platform. Understand your rights and responsibilities when using our voice biometric services."
        url="https://voicemate.id/terms"
        keywords="terms of service, user agreement, VoiceMate terms, voice identification terms, service agreement"
      />
