...
type RegistrationFormValidatorProps = {
  formState: RegistrationFormState;
};

const RegistrationFormValidator: React.FC<RegistrationFormValidatorProps> = ({
  formState
}) => {
  // This component doesn't render anything visible
  // It's just a logical component to validate the form
